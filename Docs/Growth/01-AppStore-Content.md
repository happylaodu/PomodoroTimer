...
## 5. Support & Marketing URL

### Support URL
```
https://github.com/happylaodu/pomodoro-support/issues
```
...
| 内容 | 更新频率 | 说明 |
|------|----------|------|
| Description | 每次大版本 | 添加新功能说明 |
| Promotional Text | 每月 | 根据营销活动调整 |
| Keywords | 每季度 | 根据搜索数据优化 |
| Screenshots | 每次 UI 改版 | 保持与实际界面一致 |
